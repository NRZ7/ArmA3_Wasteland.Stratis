...
// Music line
playMusic "skynet"; 65 fadeMusic 0.30; 90 fadeMusic 0;
 
_role1 = "Welcome to";
_role1names = ["StandaRol Custom A3Wasteland"];
_role2 = "Server is restarted every 8 hours";
_role2names = ["4h, 12h and 20h CEST"];
_role3 = "Visita nuestra comunidad";
_role3names = ["www.DayzStandaRol.com"];
