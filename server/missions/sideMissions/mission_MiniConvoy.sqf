...
{
	// Mission completed
	_randomBox = ["mission_USLaunchers","mission_Custom_Explosives"] call BIS_fnc_selectRandom;
	_randomBox2 = ["mission_Custom_LMG","mission_Custom_Wear"] call BIS_fnc_selectRandom;
